...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  ...
  // Define enlace here, or get it from somewhere.  For this example, I'm just setting it to a default value.
  const enlace = 'https://wirksi-box.vercel.app/';
  ...
  if (command == 'play' || command == 'mp3') {
    ...
    const texto1 = `
      ...
      > _Descargado el audio, aguarde un momento...._
    `.trim();
  ...
  if (command == 'play3' || command == 'playdoc') {
    ...
    const texto1 = `
      ...
      > _Descargado el audio en documento, aguarde un momento por favor...._
    `.trim();
  ...
  if (command == 'play4' || command == 'playdoc2') {
    ...
    const texto1 = `
      ...
      > _Descargado su video en documento, aguarde un momento por favor...._
    `.trim();
