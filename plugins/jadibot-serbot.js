...
m?.chat ? await conn.sendMessage(m.chat, {text: args[0] ? `@${m.sender.split('@')[0]}, ya estás conectado, leyendo mensajes entrantes...` : `@${m.sender.split('@')[0]}, Ahora ya eres parte de nuestra familia de *Yuru Yuri Sub-Bots.*\n> Usa #p para ver el tiempo de respuesta de la bot`, mentions: [m.sender]}, { quoted: m }) : ''
